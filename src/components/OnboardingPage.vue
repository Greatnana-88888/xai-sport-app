...
const bars = reactive([
 { height: 40, color: 'bg-gray-700' },
 { height: 55, color: 'bg-primary' },
 { height: 45, color: 'bg-gray-700' },
 { height: 70, color: 'bg-primary' },
 { height: 85, color: 'bg-gray-700' },
 { height: 60, color: 'bg-primary' },
 { height: 50, color: 'bg-gray-700' },
 { height: 75, color: 'bg-primary' },
 { height: 65, color: 'bg-gray-700' },
 { height: 55, color: 'bg-primary' },
 { height: 40, color: 'bg-gray-700' },
 { height: 60, color: 'bg-primary' },
]);
...
const updateBarHeights = () => {
 ...
 const variation = Math.sin(Date.now() / 500 + index) * 10;
